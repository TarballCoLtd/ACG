...
struct GPUPicker: View {
    ...
    let amdGenerations: [String] = ["Polaris - RX 400 & 500 series", "Navi - RX 5000 series", "Big Navi - RX 6000 series", "Vega"]
    let nvidiaGenerations: [String] = ["Kepler - GTX 700 series", "Maxwell - GTX 900 series", "Pascal - GTX 10 series", "Turing - GTX 16 series", "Turing - RTX 20 series", "Ampere - RTX 30 series"]
    // amd generation cards
    let polarisCards: [String] = ["RX 460", "RX 470", "RX 480", "RX 550", "RX 560", "RX 570", "RX 580", "RX 590"]
    let naviCards: [String] = ["RX 5500", "RX 5500 XT", "RX 5600", "RX 5600 XT", "RX 5700", "RX 5700 XT"]
    let bigNaviCards: [String] = ["RX 6600", "RX 6600 XT", "RX 6700 XT", "RX 6800", "RX 6800 XT", "RX 6900 XT"]
    let vegaCards: [String] = ["Vega 8", "Vega 11", "Vega 56", "Vega 64", "Radeon VII"]
    // nvidia generation cards
    let keplerCards: [String] = ["GT 710", "GT 720", "GT 730", "GT 740", "GTX 745", "GTX 750", "GTX 750 Ti", "GTX 760", "GTX 760 Ti", "GTX 770", "GTX 780", "GTX 780 Ti", "GTX Titan", "GTX Titan Z"]
    let maxwellCards: [String] = ["GTX 950", "GTX 960", "GTX 970", "GTX 980", "GTX 980 Ti", "GTX Titan X"]
    let pascalCards: [String] = ["GT 1010", "GT 1030", "GTX 1050", "GTX 1050 Ti", "GTX 1060", "GTX 1070", "GTX 1070 Ti", "GTX 1080", "GTX 1080 Ti", "GTX Titan X", "GTX Titan Xp"]
    let turing16Cards: [String] = ["GTX 1650", "GTX 1650 SUPER", "GTX 1660", "GTX 1660 SUPER", "GTX 1660 Ti"]
    let turing20Cards: [String] = ["RTX 2060", "RTX 2060 SUPER", "RTX 2070", "RTX 2070 SUPER", "RTX 2080", "RTX 2080 SUPER", "RTX 2080 Ti", "Titan RTX"]
    let ampereCards: [String] = ["RTX 3060", "RTX 3060 Ti", "RTX 3070", "RTX 3070 Ti", "RTX 3080", "RTX 3080 Ti", "RTX 3090"]
    // vendor
                ...
                Menu(vendor) {
                    ForEach(Array(vendorArray.enumerated()), id: \.element) { index, element in
                        Button(element) {
                            ...
                            if index == 0 {
                                vendor = "AMD"
                                generationArray = amdGenerations
                            } else if index == 1 {
                                vendor = "NVIDIA"
                                generationArray = nvidiaGenerations
                            }
                            vendorIndex = index
                            generationIndex = -1
                            cardIndex = -1
                ...
                Menu(generation) {
                    ForEach(Array(generationArray.enumerated()), id: \.element) { index, element in
                        Button(element) {
                            ...
                            if vendor == "AMD" {
                                if index == 0 {
                                    cardArray = polarisCards
                                } else if index == 1 {
                                    cardArray = naviCards
                                } else if index == 2 {
                                    cardArray = bigNaviCards
                                } else if index == 3 {
                                    cardArray = vegaCards
                                }
                            } else if vendor == "NVIDIA" {
                                if index == 0 {
                                    cardArray = keplerCards
                                } else if index == 1 {
                                    cardArray = maxwellCards
                                } else if index == 2 {
                                    cardArray = pascalCards
                                } else if index == 3 {
                                    cardArray = turing16Cards
                                } else if index == 4 {
                                    cardArray = turing20Cards
                                } else if index == 5 {
                                    cardArray = ampereCards
                                }
                            }
        ...
        if vendorIndex == 0 { // AMD
            if generationIndex == 0 { // polaris
                if cardIndex == -1 {
                    ...
                    status = "Support status: May be supported ⚠️"
                    ...
                    status = "Support status: Natively supported ✅"
            ...
            if generationIndex == 0 { // kepler
                if cardIndex == -1 {
                    ...
                    status = "Support status: May be partially supported ⚠️"
                    ...
                    status = "Support status: Partially supported ⚠️"
